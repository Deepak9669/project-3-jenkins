	...
	<form action="<%=ORSView.BRANCH_MANAGER_LIST_CTL%>" method="post">
			...
			<table class="table table-bordered table-dark table-hover">
				...
				<tbody>
					...
					<tr>
						...
						<td class="text"><%=dto.getManagerName()%></td>
						<td class="text"><%=dto.getBranchName()%></td>
						<td class="text"><%=dto.getContactNumber()%></td>

						<td class="text"><a
							href="<%=ORSView.APP_CONTEXT%>/ctl/BranchManagerCtl?id=<%=dto.getId()%>">
								Edit </a></td>
					</tr>
		...
		<table width="100%">
			<tr>
				...
				<td><input type="submit" name="operation"
					class="btn btn-primary" value="<%=BranchManagerListCtl.OP_NEW%>">
				</td>

				<td><input type="submit" name="operation"
					class="btn btn-danger" value="<%=BranchManagerListCtl.OP_DELETE%>">
				</td>

				<td align="right"><input type="submit" name="operation"
					class="btn btn-warning" value="<%=BranchManagerListCtl.OP_NEXT%>"
		...
		<div style="text-align: center;">
			<input type="submit" name="operation" class="btn btn-primary"
				value="<%=BranchManagerListCtl.OP_BACK%>">
		</div>
