...
/**
 * Audit List functionality controller to perform Search and List operation.
 */
@WebServlet(name = "AuditListCtl", urlPatterns = { "/ctl/AuditListCtl" })
public class AuditListCtl extends BaseCtl {

	private static Logger log = Logger.getLogger(AuditListCtl.class);

	@Override
	protected void preload(HttpServletRequest request) {
		// Audit me dropdown nahi hai
	}
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		log.debug("AuditListCtl doGet Start");
		...
		log.debug("AuditListCtl doGet End");
	}
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		log.debug("AuditListCtl doPost Start");
		...
		try {
			...
			dto = (AuditDTO) populateDTO(request);
		...
		log.debug("AuditListCtl doPost End");
	}
