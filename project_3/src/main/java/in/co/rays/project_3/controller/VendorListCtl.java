...
/**
 * Vendor List Controller for Search and List functionality
 */
...
public class VendorListCtl extends BaseCtl {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		log.debug("VendorListCtl doGet Start");
		...
		log.debug("VendorListCtl doGet End");
	}
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		log.debug("VendorListCtl doPost Start");
		...
		log.debug("VendorListCtl doPost End");
	}
